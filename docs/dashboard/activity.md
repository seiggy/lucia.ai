...
The Parser Rate metric helps you understand usage patterns. A consistently high rate means you may benefit from tweaking response templates; a low rate means the LLM orchestrator is doing the heavy lifting on complex requests.
